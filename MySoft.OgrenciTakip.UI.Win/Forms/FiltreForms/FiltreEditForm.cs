...
namespace MySoft.OgrenciTakip.UI.Win.Forms.FiltreForms
{
    public partial class FiltreEditForm : BaseEditForm
    {
        ...
        public FiltreEditForm(params object[] prm)
        {
            ...
            ShowItems = new BarItem[] { btnFarkiKaydet, btnUygula };
        ...
        {
            if (!IsLoaded) return;
            GeneralFunctions.ButtonEnabledDurumu(btnKaydet, btnFarkiKaydet, btnSil, BaseIslemTuru, OldEntity, CurrentEntity);
        }
    }
}