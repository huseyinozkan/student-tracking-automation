...
namespace MySoft.OgrenciTakip.UI.Win.UserControls.UserControl.GenelEditFormTable
{
    public partial class MakbuzHareketleriTable : BaseTablo
    {
        ...
        protected override void SutunGizleGoster()
        {
            ...
            colBelgeDurum.Visible = entity.OdemeTipi == OdemeTipi.Cek || entity.OdemeTipi == OdemeTipi.Elden;
        ...
        protected override void HareketSil()
        {
            ...
            var entity = tablo.GetRow<MakbuzHareketleriL>(true);
            if (entity == null) return;

            if (entity.Id != 0 ||entity.Id < entity.SonHareketId)
            {
                Messages.OdemeBelgesiSilinemezMesj(true);
                return;
            }
        ...
        protected internal override bool HataliGiris()
        {
            ...
            for (int i = 0; i < tablo.DataRowCount; i++)
            {
                ...
                if (entity.IslemOncesiTutar > entity.IslemOncesiTutar)
                {
                    tablo.FocusedRowHandle = i;
                    tablo.FocusedColumn = colIslemTutari;
