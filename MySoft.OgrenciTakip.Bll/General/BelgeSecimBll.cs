            ...
            return List(filter, x => new
            {
                ...
                Toplamlar = x.MakbuzHareketleri.GroupBy(y => y.OdemeBilgileriId).DefaultIfEmpty().Select(y => new
                {
                    Tahsil = y.Where(z => z.BelgeDurumu == BelgeDurumu.AvukatYoluylaTahsilEtme
                                        ...
                                        || z.BelgeDurumu == BelgeDurumu.TahsilEtmeKasa)
                              .Select(z => z.IslemTutari)
                              .DefaultIfEmpty(0)
                              .Sum(),
                    ...
                    SonHesapId = y.OrderByDescending(z => z.Id).Select(z => z.Makbuz.AvukatHesapId
                                                                          ?? z.Makbuz.BankaHesapId
                                                                          ?? z.Makbuz.CariHesapId
                                                                          ?? z.Makbuz.KasaHesapId
                                                                          ?? z.Makbuz.SubeHesapId).FirstOrDefault(),
                    ...
                    SubeId = !y.Any()
                          ? x.Tahakkuk.SubeId
                          : y.OrderByDescending(z => x.Id).FirstOrDefault().BelgeDurumu == BelgeDurumu.OnayBekliyor
                          ? y.OrderByDescending(z => z.Id).FirstOrDefault().YeniSubeId
                          : y.OrderByDescending(z => z.Id).FirstOrDefault().EskiSubeId,
                  ...
                  makbuzTuru == MakbuzTuru.PortfoyeGeriIade ? (y.Toplamlar.BelgeDurumu == BelgeDurumu.CiroEtme || y.Toplamlar.BelgeDurumu == BelgeDurumu.BankayaTahsileGonderme) && y.Toplamlar.HesapTuru == makbuzHesapTuru && y.Toplamlar.SonHesapId == hesapId :
                  makbuzTuru == MakbuzTuru.PortfoyeGeriIade ? (y.Toplamlar.BelgeDurumu == BelgeDurumu.CiroEtme || y.Toplamlar.BelgeDurumu == BelgeDurumu.AvukataGonderme || y.Toplamlar.BelgeDurumu == BelgeDurumu.KismiAvukatYoluylaTahsilEtme || y.Toplamlar.BelgeDurumu == BelgeDurumu.BankayaTahsileGonderme) && (y.Toplamlar.HesapTuru == makbuzHesapTuru && y.Toplamlar.SonHesapId == hesapId) :
                  ...
                  y.Toplamlar.BelgeDurumu == 0 // Buraya hiçbir zaman düşmeyecek. Boş kalamadığı için dolduruldu.
